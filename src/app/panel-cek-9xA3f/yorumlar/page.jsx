    ...
    <div style={{ padding: 24 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
          ...
          <button className="btn-secondary" type="button" onClick={fetchItems}>
            Yenile
          </button>
        </div>
      </div>
          ...
          {items.map((t) => (
            ...
            >
              ...
              <div style={{ marginTop: 12, display: "flex", gap: 10 }}>
                {tab === "pending" ? (
                  <button className="btn-success" type="button" onClick={() => approve(t.id)}>
                    Onayla
                  </button>
                ) : (
                  <button className="btn-primary" type="button" onClick={() => unapprove(t.id)}>
                    Yayından Kaldır
                  </button>
                )}

                <button className="btn-primary" type="button" onClick={() => remove(t.id)}>
                  Sil
                </button>
              </div>
            </div>
