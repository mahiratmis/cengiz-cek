    ...
    <div className="admin-layout">
      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav">
          ...
          <Link href="/admin/subeler" className="admin-nav-link">
            📍 Şubeler
          </Link>
          <Link href="/admin/kadro" className="admin-nav-link">
            👩‍🏫 Kadro
          </Link>
          <Link href="/admin/duyurular" className="admin-nav-link">
            📢 Duyurular
          </Link>
          <Link href="/admin/basarilar" className="admin-nav-link">
            🏆 Başarılarımız
          </Link>
          <Link href="/admin/basvurular" className="admin-nav-link">
            📝 Sınav Başvuruları
          </Link>
          <Link href="/admin/yorumlar" className="admin-nav-link">💬 Yorumlar</Link>
